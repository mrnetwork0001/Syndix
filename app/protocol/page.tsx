          ...
          <table className="w-full text-left text-[13.5px]">
            ...
            <tbody>
              {[
                ...
                ["Proof of read", "Real, and measured by the server. A signed session is stamped with the server clock, heartbeats carry scroll depth, and beats arriving faster than real time are refused - dwell is never client-reported. It proves time and scrolling, not comprehension, and that limit is not hypothetical: on 18 August 2026 eighteen up.id holders claimed one issue within about eighteen seconds of each other, each carrying a genuine server-measured session of 49 to 179 seconds. Nothing was bypassed - they opened the issue together and waited out the timer. The gate sets a floor on effort; it is not evidence of attention.", "caution"],
                ...
                ["x402 endpoint", "Real 402 flow, real onchain verification, custom scheme. Settlement is checked against the receipt, but the scheme is giwa-native-transfer rather than x402's exact - exact needs an EIP-3009 authorisation and native ETH cannot carry one.", "positive"],
                ["Attention ledger", "Real. A reader's proven reading record and a sponsor's receipt for an issue, both derived from RewardClaimed logs - recomputable from the contract by anyone. Certified dwell is decoded from claim calldata and labelled as attester-signed evidence, not independent proof.", "positive"],
